...
const Profile = () => {
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '30px', justifyContent: 'center' }}>
      <div>
        <h2>Graph 1</h2>
        <img src="http://localhost:8081/graph_department.png" alt="Graph 1" style={{ width: '100%' }} />
      </div>
      <div>
        <h2>Graph 2</h2>
        <img src="http://localhost:8081/graph_hourly_daily.png" alt="Graph 2" style={{ width: '100%' }} />
      </div>
      <div>
        <h2>Graph 3</h2>
        <img src="http://localhost:8081/graph_monthly_income_boxplot.png" alt="Graph 3" style={{ width: '100%' }} />
      </div>
      <div>
        <h2>Graph 4</h2>
        <img src="http://localhost:8081/graph_monthly_income.png" alt="Graph 4" style={{ width: '100%' }} />
      </div>
      <div>
        <h2>Graph 5</h2>
        <img src="http://localhost:8081/graph_overtime.png" alt="Graph 5" style={{ width: '100%' }} />
      </div>
      <div>
        <h2>Data Table 1</h2>

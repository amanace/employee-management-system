...
# if highest_hourly_rate_doc is not None:
#     hourlyrate.append({"highest": highest_hourly_rate_doc['Hourly Rate']})

# if smallest_hourly_Rate is not None:
#     hourlyrate.append({"lowest": smallest_hourly_Rate['Hourly Rate']})
